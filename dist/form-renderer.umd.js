(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('core-js/modules/es.array.map'), require('core-js/modules/es.function.name'), require('core-js/modules/es.array.filter'), require('core-js/modules/es.array.join'), require('core-js/modules/es.array.slice'), require('core-js/modules/es.number.constructor'), require('core-js/modules/es.array.is-array'), require('core-js/modules/es.date.to-string'), require('core-js/modules/es.object.to-string'), require('core-js/modules/es.regexp.to-string'), require('core-js/modules/es.object.keys'), require('core-js/modules/es.array.concat'), require('core-js/modules/es.array.iterator'), require('core-js/modules/es.promise'), require('core-js/modules/es.string.iterator'), require('core-js/modules/web.dom-collections.iterator')) :
  typeof define === 'function' && define.amd ? define(['exports', 'core-js/modules/es.array.map', 'core-js/modules/es.function.name', 'core-js/modules/es.array.filter', 'core-js/modules/es.array.join', 'core-js/modules/es.array.slice', 'core-js/modules/es.number.constructor', 'core-js/modules/es.array.is-array', 'core-js/modules/es.date.to-string', 'core-js/modules/es.object.to-string', 'core-js/modules/es.regexp.to-string', 'core-js/modules/es.object.keys', 'core-js/modules/es.array.concat', 'core-js/modules/es.array.iterator', 'core-js/modules/es.promise', 'core-js/modules/es.string.iterator', 'core-js/modules/web.dom-collections.iterator'], factory) :
      ...
      validateRule: function validateRule() {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            for (var si = 0, len = page.sections.length; si < len; si++) {
              var section = page.sections[si];
              rule[section.key] = {};

              if (section.validates) {
                for (var i = 0, _len = section.validates.length; i < _len; i++) {
  ...
  var __vue_inject_styles__$b = function __vue_inject_styles__(inject) {
    if (!inject) return;
    inject("data-v-573c67b8_0", {
      source: ".form-renderer .clearfix:before,\n.form-renderer .clearfix:after {\n  content: '';\n  display: table;\n}\n.form-renderer .clearfix:after {\n  clear: both;\n}\n",
      map: {
        "version": 3,
        "sources": ["renderer.vue"],
        "names": [],
        "mappings": "AAAA;;EAEE,WAAW;EACX,cAAc;AAChB;AACA;EACE,WAAW;AACb",
        "file": "renderer.vue",
        "sourcesContent": [".form-renderer .clearfix:before,\n.form-renderer .clearfix:after {\n  content: '';\n  display: table;\n}\n.form-renderer .clearfix:after {\n  clear: both;\n}\n"]
      },
      media: undefined
    });
  };
